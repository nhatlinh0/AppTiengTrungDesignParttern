...
public class Hsk4writeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hskwrite4_layout);
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Hsk4writeActivity.this, MainActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(listCount == 40){
                    ...
                    Intent intent = new Intent(Hsk4writeActivity.this, ResultActivity.class);
        ...
        btnPrev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                init(listCount);
                if(listCount < 35){
                    timeLeftFormatted = Hsk3writeActivity.timeLeftFormatted;
                    Hsk2listenActivity.tvTime.setText(timeLeftFormatted);
                    Intent intent = new Intent(Hsk4writeActivity.this, Hsk3writeActivity.class);
                    startActivity(intent);
                }
            }
        });
    ...
    void listAdd() {
        ...
        listenList.add(new Hsk3write(1, "坐", "zuò", "昨天 是 8()19 日 。", "Zuótiān shì rì.", "E"));
        listenList.add(new Hsk3write(2, "前面", "qiánmiàn", "那个 饭馆儿 在 火车站()", "Nàge fànguǎnr zài huǒchēzhàn", "B"));
        listenList.add(new Hsk3write(3, "没 关系", "guānxi", "你会说 ( )吗 ?", "Nǐ huì shuō ma?", "D"));
        listenList.add(new Hsk3write(4, "汉语", "Hànyǔ", "在 ,请 ( ),我去叫他 。", "Zài, qǐng wǒ qù jiào tā.", "A"));
        listenList.add(new Hsk3write(5, "月", "yuè", "()我会 。", "wǒ huì.", "C"));
    }
    ...
    void checkScore (){
        for(int i = 0; i< listCount-35;i++) {
            if(answerList.get(i+35).equals(listenList.get(i).correctAnswer)) {
                score +=5;
            }
        }
    }
